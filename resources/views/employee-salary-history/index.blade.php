...
<form method="GET" action="{{url('employees/salaries/delete-selected')}}" class="form-div modal-content-div">
  {{ csrf_field() }}
  @method('DELETE')
	...
	@if(auth()->user()->authority('export','employees')==1)
      ...
      @if(auth()->user()->authority('modify','employees')==1)
        <div class="col-lg-6 col-md-6 col-sm-12 add-product-div">
            <a href="{{url('employees/salaries/create')}}" type="button" class="btn btn-primary add-btn" style="background-color: #376861 !important;">
...
<!---------------- users table  !------------------->
  <div class="system-table-div goods-table-div">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header table-header">Employee Salariey History List</h5>
              <div class="card-body">
                  <div class="table-responsive">
				  <!----------------datatabled table  !------------------->
                      <table class="table table-striped table-bordered first data-table" id="employees-salaries-table">
                          <thead>

                              <tr>
                                
                                    <th><input type="checkbox" id="select_all_employees_salaries"/></th>
                               
								  
								  <th scope="col" class="img-title text-center"> Employee</th>  
								  <th scope="col" class="img-title text-center"> Salary</th>
								   <th scope="col" class="img-title text-center"> Start</th>
								   <th scope="col" class="img-title text-center">End</th>
