...
@section('content')
 ...
 <form method="POST" action="{{url('permissions/update/'.$permission->id)}}" id="form1" style="margin-bottom:10px;">
 @csrf
 ...
 <div class="form-group col-lg-6 col-md-6 col-sm-12">
    <label for="role" class="role col-sm-4 col-form-label">Permission Type  :</label>
   ...
   <input type="checkbox"class="form-check-input" style="background-color: #fff;" name="is_paid" value="1" @if($permission->is_paid ==1) checked @endif >
