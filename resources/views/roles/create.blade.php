...
<!---------------- role add section  !------------------->
 <form method="POST" action="{{url('roles/store')}}" id="form1" style="margin-bottom:10px;">
 @csrf
  <div class="row">
 <div class="form-group col-lg-6 col-md-6 col-sm-12">
    <label for="role" class="role col-sm-4 col-form-label">Role Name :</label>
  
      <input type="text" class="form-control" style="background-color: #fff;" name="name" id="role" required>
    </div>
  </div>
                      ...
                      <table class="table table-striped table-bordered first data-table" >
                          <thead>
							  ...
							  <th scope="col" class="product-name-title text-center">Page</th>
                                  <th scope="col" class="product-name-title text-center">View</th>
						 ...
						 @while($counter < $count)
						  ...
						  {{$pages[$counter]['name'] }}
						   ...
						   <td class="check-product-div text-center">
						    <input type="checkbox" class="form-check-input" name="view[{{$counter}}]" value="1" style="margin-left:50px">
						  </td>
						    <td class="check-product-div text-center">
							 <input type="checkbox" class="form-check-input" name="modify[{{$counter}}]"  value="1" style="margin-left:50px;">
						  </td>
						   <td class="check-product-div text-center">
						   <input type="checkbox" class="form-check-input" name="export[{{$counter}}]" value="1" style="margin-left:50px">
						  </td>
						   <td class="check-product-div text-center">
						   <input type="checkbox" class="form-check-input" name="view_only_employee_data[{{$counter}}]" value="1" style="margin-left:50px">
						  </td>
						  </tr>
						   @php ($counter++)
						   @endwhile
