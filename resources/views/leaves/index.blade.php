...
<form method="GET" action="{{url('leaves/delete-selected')}}" class="form-div modal-content-div">
  {{ csrf_field() }}
  @method('DELETE')
   
 <div class="table-outer-options-div">
    <div class="row">
	 @if(auth()->user()->authority('export','leave_types')==1)
		...
		<div class="col-lg-6 col-md-6 col-sm-12 add-product-div">
            <a href="{{url('leaves/create')}}" type="button" class="btn btn-primary add-btn" style="background-color: #376861 !important;">
     ...
     <div class="system-table-div goods-table-div">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header table-header">Leaves</h5>
              <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-striped table-bordered first data-table" id="leaves-table" >
                          <thead>

                              <tr>
							   <th>
                                    <input type="checkbox" id='leaves-table-checkall' />
                                </th>
							      <th scope="col" class="product-name-title text-center">type</th>
                                  <th scope="col" class="category-title text-center">paid</th>
								  <th scope="col" class="category-title text-center">Solde Deduction </th>
                ...
                <div class="modal-body import-modal-body">
                    ...
                    <div class="step-div second-step">
                        <div class="step-title">
                            ...
                            <span class="step-p">Add the file that was uploaded in the previous step to insert Leaves.</span>
                        </div>
                        <div class="step-content">
                            <form method="post" enctype="multipart/form-data" action="{{url('leaves/import')}}"class="upload-import-file-form">
							 {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="form-label">Upload File</label>
                                    <div class="form-img-div">
                                        <input type='file' name="leave_import" onchange="readURL(this);" />
