...
<form method="GET" action="{{url('employee/solde/deduction/delete-selected')}}" class="form-div modal-content-div">
  {{ csrf_field() }}
  @method('DELETE') 
 <div class="table-outer-options-div">
	...
	@if(auth()->user()->authority('export','assign_employee_permission')==1 )
		...
		<div class="col-lg-6 col-md-6 col-sm-12 add-product-div">
            <a href="{{url('employee/solde/deduction/create')}}" type="button" class="btn btn-primary add-btn" style="background-color: #376861 !important;">
                <i class="fas fa-plus-circle"></i>
                <span> Deduct Employee's Solde </span>
            </a>
     ...
     <div class="system-table-div goods-table-div">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header table-header">Employees Solde Deduction</h5>
              <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-striped table-bordered first data-table" id="employees-sold-deduction-table" >
                          <thead>

                              <tr>
							      <th>
                                    <input type="checkbox" id='employees-sold-deduction-table-checkall' />
                                </th>
                                  <th scope="col" class="category-title text-center">Employee</th>
								  <th scope="col" class="category-title text-center">Deducted Solde</th>
								  <th scope="col" class="category-title text-center">Note</th>
							      <th scope="col" class="category-title text-center">Deducted By</th>
