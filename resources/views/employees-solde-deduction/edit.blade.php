...
@section('content')
 ...
 <form method="POST" action="{{url('employee/solde/deduction/update/'.$EmployeeSoldeDeduction->id)}}" id="form1" style="margin-bottom:10px;">
 @csrf
   <p class="fullwidth-collapse-div">
              <a class="btn btn-light" data-toggle="collapse" href="#basic-info-div" role="button" aria-expanded="false" aria-controls="basic-info-div">
                  ...
                  Edit Employee's Deducted Solde
              </a>
          </p>
   ...
   <div class="form-group col-lg-6 col-md-6 col-sm-12">
    <label  class="role col-sm-4 col-form-label">Employee:</label>
      ...
      <select  class="form-control" name="employee_id" id='selEmployee' required>
	    <option value="{{$EmployeeSoldeDeduction->employee->id}}">{{$EmployeeSoldeDeduction->employee->full_name_en}}</option>
	...
	<div class="form-group col-lg-6 col-md-6 col-sm-12">
	 <label  class="role col-sm-4 col-form-label">Deducted Solde :</label>
      <input type="float" class="form-control" name="deducted_solde" value="{{$EmployeeSoldeDeduction->deducted_solde}}" required>
 ...
 <div class="form-group col-lg-6 col-md-6 col-sm-12">
    <label  class="role col-sm-4 col-form-label">Note :</label>
      ...
      <textarea type="date" class="form-control" col="5" row="3" name="note" >{{$EmployeeSoldeDeduction->note}}</textarea>
    </div>
  </div>
