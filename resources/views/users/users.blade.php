...
<form method="GET" action="{{url('users/delete-selected')}}" class="form-div modal-content-div">
  {{ csrf_field() }}
  @method('DELETE')
<div class="table-outer-options-div">
    <div class="row">
	@if(auth()->user()->authority('export','users')==1)
        <div class="btn-group col-lg-6 col-md-6 col-sm-12 excel-options-div" role="group" aria-label="Basic example">
		
		 <a href="{{url('users/users_print')}}">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 add-product-div">
            <a href="{{url('users/create')}}" type="button" class="btn btn-primary add-btn" style="background-color: #376861 !important;">
...
<!---------------- users table  !------------------->
  <div class="system-table-div goods-table-div">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header table-header">Users List</h5>
              <div class="card-body">
                          ...
                          <thead>
                              ...
                              <tr>
                                <th scope="col" class="img-title text-center check-all-parent">
                                  ...
                                  <th scope="col" class="img-title text-center"> id</th>
                                  <th scope="col" class="product-name-title text-center">name</th>
                                  <th scope="col" class="category-title text-center">email</th>
                ...
                <div class="modal-body import-modal-body">
                    ...
                    <div class="step-div second-step">
                        <div class="step-title">
                            ...
                            <span class="step-p">Add the file that was uploaded in the previous step to insert users.</span>
                        </div>
                        <div class="step-content">
                            <form method="post" enctype="multipart/form-data" action="{{url('users/import_users')}}"class="upload-import-file-form">
							 {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="form-label">Upload File</label>
                                    <div class="form-img-div">
                                        <input type='file' name="users_import" onchange="readURL(this);" />
