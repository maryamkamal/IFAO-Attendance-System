...
<form method="GET" action="{{url('work/schedules/delete-selected')}}" class="form-div modal-content-div">
  {{ csrf_field() }}
  @method('DELETE')
<div class="table-outer-options-div">
    <div class="row">
	@if(auth()->user()->authority('export','work_schedule_profiles')==1)
        <div class="btn-group col-lg-6 col-md-6 col-sm-12 excel-options-div" role="group" aria-label="Basic example">
            ...
            <a href="{{url('work/schedules/export')}}">
		...
		@if(auth()->user()->authority('modify','work_schedule_profiles')==1)
		 <div class="col-lg-6 col-md-6 col-sm-12 add-product-div">
            <a href="{{url('work/schedules/create')}}" type="button" class="btn btn-primary add-btn" style="background-color: #376861 !important;">
                <i class="fas fa-plus-circle"></i>
                <span> Add Work schedule Profile </span>
            </a>
   ...
   <!---------------- role table  !------------------->
     <div class="system-table-div goods-table-div">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header table-header"> Work schedule Profiles</h5>
              <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-striped table-bordered first data-table" id ="work-profile-table" >
                          <thead>

                              <tr>
							   <th>
                                    <input type="checkbox" id='work-profile-table-checkall' />
                                </th>
							   <th scope="col" class="product-name-title text-center">schedule ID</th>
							  <th scope="col" class="product-name-title text-center">schedule Name</th>
                                  <th scope="col" class="product-name-title text-center">Start</th>
                                  <th scope="col" class="category-title text-center">End</th>
								  <th scope="col" class="category-title text-center">Work Days</th>
								   <th scope="col" class="category-title text-center">Work Duration</th>
        ...
        <div class="modal-dialog" id="big-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">Import / Export Work Schedules</h5>
                ...
                <div class="modal-body import-modal-body">
                    ...
                    <div class="step-div second-step">
                        <div class="step-title">
                            ...
                            <span class="step-p">Add the file that was uploaded in the previous step to insert Work Schedules.</span>
                        </div>
                        <div class="step-content">
                            <form method="post" enctype="multipart/form-data" action="{{url('work/schedules/import')}}"class="upload-import-file-form">
							 {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="form-label">Upload File</label>
                                    <div class="form-img-div">
                                        <input type='file' name="Work_Schedule_Profile_import" onchange="readURL(this);" />
