...
@section('content')
    ...
    <div class="add-new-product-div">
        <form method="POST" action="{{url('attendance-net/store')}}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-body basic-info-content">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="float" class="form-control" name="worked_duration" required>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            <label class="form-label">Overtime Net Percentage</label>
                            <input type="float" class="form-control" name="overtime_net_percentage" >
                        </div>
                    </div>
					<div class="row">
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            <label class="form-label">Delay Minutes </label>
                            <input type="float" class="form-control" name="delay_minutes" >
                        </div>
						</div>
